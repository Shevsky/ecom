	...
	return (
		<>
			<Field
				...
				description={`Плагин будет логировать ход своих действий при произведении расчета стоимости доставки. Режим отладки плагина будет работать только при включенном режиме отладки сайта (устанавливается в приложении "Настройки")`}
			>
